...
vim.keymap.set("n", "<C-d>", "<C-d>zz", { noremap = true, desc = "Center cursor on Ctrl d" })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { noremap = true, desc = "Center cursor on Ctrl u" })
vim.keymap.set("n", "<leader>x", ":.lua<CR>", { silent = true, desc = "Source a single line" })
vim.keymap.set("v", "<leader>x", ":lua<CR>", { silent = true, desc = "Source selection" })
vim.keymap.set("n", "<leader><leader>x", "<cmd>source %<CR>", { silent = true, desc = "Source entire file" })
